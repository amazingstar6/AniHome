...
import com.kevin.anihome.DeleteEntryMutation
import com.kevin.anihome.GetMyMediaQuery
import com.kevin.anihome.MainActivity
import com.kevin.anihome.UpdateStatusMutation
...
import com.kevin.anihome.data.repository.mediadetail.getFuzzyDate
import com.kevin.anihome.fragment.MyMedia
import com.kevin.anihome.type.FuzzyDateInput
...
@Singleton
class MyMediaRepositoryImpl
    @Inject
    constructor() : MyMediaRepository {
        override suspend fun getMyMedia(
            ...
            try {
                ...
                val client =
                    if (useNetworkFirst) {
                        Apollo.apolloClient.newBuilder()
        ...
        override suspend fun updateProgress(statusUpdate: StatusUpdate): AniResult<Media> {
                ...
                val result =
                    Apollo.apolloClient.mutation(
                        UpdateStatusMutation(
                            ...
                            progressVolumes =
                                if (statusUpdate.progressVolumes == null) {
                                    Optional.Absent
                                } else {
                                    Optional.present(
                            ...
                            private =
                                if (statusUpdate.privateToUser == null) {
                                    Optional.Absent
                                } else {
                                    Optional.present(
                            ...
                            hiddenFromStatusLists =
                                if (statusUpdate.hiddenFromStatusList == null) {
                                    Optional.Absent
                                } else {
                                    Optional.present(
                            ...
                            customLists =
                                if (statusUpdate.customLists == null) {
                                    Optional.Absent
                                } else {
                                    Optional.present(
                            ...
                            advancedScores =
                                if (statusUpdate.advancedScores == null) {
                                    Optional.Absent
                                } else {
                                    Optional.present(
