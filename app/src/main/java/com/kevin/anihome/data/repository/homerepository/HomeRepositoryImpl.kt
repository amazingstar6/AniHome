...
import com.kevin.anihome.data.repository.TrendingTogetherPagingSource
...
import com.kevin.anihome.ui.home.AniMediaSort
import com.kevin.anihome.ui.home.MediaSearchState
import com.kevin.anihome.ui.home.SearchFilter
...
class HomeRepositoryImpl
    ...
    constructor() : HomeRepository {
        fun trendingTogetherPagingSource(isAnime: Boolean) = TrendingTogetherPagingSource(this, isAnime = isAnime)

        override fun trendingNowPagingSource(isAnime: Boolean) = MediaPagingSource(this, HomeTrendingTypes.TRENDING_NOW, isAnime = isAnime)

        override fun popularThisSeasonPagingSource() = MediaPagingSource(this, HomeTrendingTypes.POPULAR_THIS_SEASON, isAnime = true)

        override fun upcomingNextSeasonPagingSource() = MediaPagingSource(this, HomeTrendingTypes.UPCOMING_NEXT_SEASON, isAnime = true)
        ...
        override fun top100AnimePagingSource(isAnime: Boolean) = MediaPagingSource(this, HomeTrendingTypes.TOP_100_ANIME, isAnime = isAnime)

        override fun popularManhwaPagingSource() = MediaPagingSource(this, HomeTrendingTypes.POPULAR_MANHWA, isAnime = false)
        ...
        private fun parseMediaTitleCover(media: MediaTitleCover): Media {
            return Media(
                id = media.id,
                type = media.type?.toAniHomeType() ?: com.kevin.anihome.data.models.AniMediaType.UNKNOWN,
