            ...
            notification?.onRelatedMediaAdditionNotification?.let { onRelatedMediaAdditionNotification ->
                list.add(
                    AniNotification(
                        ...
                        mediaTitle = onRelatedMediaAdditionNotification.media?.title?.userPreferred
                            ?: "",
                        image = onRelatedMediaAdditionNotification.media?.coverImage?.extraLarge
                            ?: ""
                    )
                )
            }
            notification?.onMediaDataChangeNotification?.let { onMediaDataChangeNotification ->
                list.add(
                    AniNotification(
                        ...
                        mediaTitle = onMediaDataChangeNotification.media?.title?.userPreferred
                            ?: "",
            ...
            notification?.onMediaMergeNotification?.let { onMediaMergeNotification ->
                list.add(
                    AniNotification(
                        ...
                        deletedMediaTitles = onMediaMergeNotification.deletedMediaTitles?.filterNotNull()
                            .orEmpty(),
